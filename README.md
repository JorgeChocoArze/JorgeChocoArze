...
const jorge = {
    ...
    technologies: {
        ...
        frontEnd: ["Vue.js", "Livewire", "Blade", "Tailwind CSS"],
        mobile: ["React Native"],
        databases: ["MySQL", "PostgreSQL"],
        devOps: ["Docker", "Git", "Linux"],
        apis: ["WhatsApp API", "Facebook API", "REST APIs"]
    },
    
    currentFocus: "Building SaaS platforms & exploring React Native",
...
| 🌐 Web Development | ⚙️ Automation | 📱 Mobile |
|:---:|:---:|:---:|
| Custom Laravel Apps | Business Process Automation | React Native Apps |
| SaaS Platforms | API Integrations | Cross-platform Solutions |
| E-commerce Solutions | WhatsApp & Facebook APIs | Mobile-first Design |
